...
3. **Review relevant rules**: Check existing development rules (e.g., `ai-specs/specs/base-standards.mdc`) to identify which rules relate to the feedback and could be improved.
...
- If a plan file `ai-specs/changes/[ID]_frontend.md` exists, update its **Implementation Status** section:
  - `Status: ✅ implemented`, PR number/URL, branch name, date.
- If you generated reusable patterns or decisions worth documenting, save them in `docs/guides/[descriptive-name].md` — **not** in `ai-specs/changes/`.
